    ...
    <div class="wrapper wrapper--w790">
        <div class="card card-5">
            <div class="card-heading">
                <h2 class="title">Editar infant</h2>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('infants.update', $persona) }}" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" id="cognoms" name="cognoms" placeholder="Escriu el cognom" value="{{ old('cognoms' , $persona->cognoms) }}" maxlength="40" required>
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="curs" name="curs" required>
                            ...
                            @forelse ($cursos as $curs)
                                <option value="{{ $curs->curs_id }}" {{old('curs', $persona->infant->curs_id) == $curs->curs_id ? 'selected' : '' }}>{{ $curs->nom }}</option>
                            @empty
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="grup" name="grup" required>
                            ...
                            @forelse ($grups as $grup)
                                <option value="{{ $grup->grup_id }}" {{old('grup', $persona->infant->grup_id) == $grup->grup_id ? 'selected' : '' }}>{{ $grup->nom }}</option>
                            @empty
                      ...
                      <div class="col-md-4 my-3">
                        <select class="form-select" id="alergies" name="alergies" required>
                          <option value="">Escollir...</option>
                          <option value="1" {{old('alergies', $persona->infant->infantSalut->alergies) == 1 ? 'selected' : '' }}>Sí</option>
                          <option value="0" {{old('alergies', $persona->infant->infantSalut->alergies) == 0 ? 'selected' : '' }}>No</option>
                        </select>
                        <div class="invalid-feedback">
                      ...
                      <div class="col-12" id="divAlergia">
                        ...
                        <textarea type="text" class="form-control" id="alergia" name="alergia" placeholder="Explica les al·lèrgies de l'infant" rows="4">{{ old('alergia', $persona->infant->infantSalut->alergia) }}</textarea>
                        <div class="invalid-feedback">
                      ...
                      <button class="w-100 btn btn-primary btn-lg" id="botoBack">EDITAR INFANT</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('js')
<script src="{{asset('/js/infants/infantEdit.js')}}"></script> 
@endsection